# Plan de Implementación Final para la Pestaña 'Prompt Generator'

## Resumen
Este documento describe el plan detallado y final para implementar la nueva pestaña 'Prompt Generator' en la aplicación Pixeo, con los modos 'Replicar' y 'Mejorar'. Se han adaptado las plantillas de prompts para que sean compatibles con el modelo `OpenGVLab/InternVL3-78B-TEE` y se han creado plantillas específicas para cada modo.
...
1. **Plantillas de Prompts**:
   - Se han creado dos plantillas específicas para cada modo:
     - `prompt_templates.md`: Plantilla para el modo 'Replicar'.
     - `prompt_templates_improve.md`: Plantilla para el modo 'Mejorar'.
